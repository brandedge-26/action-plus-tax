  ...
  return (
    <div className="w-full max-w-[440px]">
      ...
      <div className="bg-white rounded-2xl p-8" style={{ border: "1px solid var(--gray-border)", boxShadow: "0 1px 8px rgba(0,0,0,0.04)" }}>
        <div className="mb-7">
          <h1 className="text-2xl font-bold mb-1.5" style={{ color: "var(--black)" }}>Create your account</h1>
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="text-xs font-medium" style={{ color: "var(--gray-text)" }}>or create with email</span>
          <div className="flex-1 h-px" style={{ background: "var(--gray-border)" }} />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-semibold mb-1.5" style={{ color: "var(--black)" }}>First Name</label>
            ...
            <div>
              <label className="block text-xs font-semibold mb-1.5" style={{ color: "var(--black)" }}>Last Name</label>
          ...
          <div>
            <label className="block text-xs font-semibold mb-1.5" style={{ color: "var(--black)" }}>Phone Number</label>
          ...
          <div>
            <label className="block text-xs font-semibold mb-1.5" style={{ color: "var(--black)" }}>Password</label>
            <div className="relative">
              ...
              <button type="button" onClick={() => setShowPassword((v) => !v)}
                className="absolute right-3.5 top-1/2 -translate-y-1/2" style={{ color: "var(--gray-text)" }}>
          ...
          <label className="flex items-start gap-2.5 cursor-pointer">
            <input type="checkbox" className="w-4 h-4 rounded mt-0.5" style={{ accentColor: "var(--primary)" }} />
            <span className="text-xs leading-relaxed" style={{ color: "var(--gray-text)" }}>
              I agree to the{" "}
              <Link href="/terms" className="font-semibold hover:underline" style={{ color: "var(--primary)" }}>Terms of Service</Link>
              {" "}and{" "}
