...
export default function DropOffPage() {
  return (
    <>
      <HeaderTest />
      <ServiceInactiveBanner slug="drop-off" />
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center py-8 lg:py-12">
              <div className="flex flex-col gap-6">
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-white tracking-tight leading-[1.1]">
                  Drop Off &amp; Go{" "}<span style={{ color: "#FFF200" }}>Tax Service</span>
                </h1>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-4 rounded-xl border border-gray-100" style={{ background: "#F0F8FA" }}>
              ...
              <div className="rounded-3xl p-8 border" style={{ background: "#041E42", borderColor: "rgba(255,255,255,0.07)" }}>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs font-bold uppercase tracking-widest" style={{ color: "#FFF200" }}>What to Bring</span>
                </div>
