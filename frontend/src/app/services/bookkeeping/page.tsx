...
export default function BookkeepingPage() {
  return (
    <>
      <HeaderTest />
      <ServiceInactiveBanner slug="bookkeeping" />
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start py-14 lg:py-20">
              ...
              <div className="flex flex-col gap-6">
                <nav className="flex items-center gap-1.5 text-xs text-white/50">
                  ...
                  <ChevronRight size={11} strokeWidth={2.5} />
                  <span style={{ color: "#FFF200" }}>Bookkeeping</span>
                </nav>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0A0A] tracking-tight">
                Getting Your Books <span style={{ color: "#01567E" }}>In Order</span>
              </h2>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">
                Everything Your <span style={{ color: "#FFF200" }}>Books Need</span>
              </h2>
