...
export default function IndividualTaxPage() {
  return (
    <>
      <HeaderTest />
      <ServiceInactiveBanner slug="individual-tax" />
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start py-14 lg:py-20">
              <div className="flex flex-col gap-6">
                <nav className="flex items-center gap-1.5 text-xs text-white/50">
                  ...
                  <ChevronRight size={11} strokeWidth={2.5} />
                  <span style={{ color: "#FFF200" }}>Individual Tax</span>
                </nav>
                <span className="inline-flex items-center self-start text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full" style={{ background: "#FFF200", color: "#041E42" }}>Tax Services</span>
                <h1 className="text-4xl sm:text-5xl font-bold text-white tracking-tight leading-[1.1]">
                  Individual Income<br /><span style={{ color: "#FFF200" }}>Tax Filing</span>
                </h1>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[{ v: "All", l: "Income Types" }, { v: "Max", l: "Refund Guaranteed" }, { v: "Same Day", l: "Refund Advance" }].map((h) => (
                    <div key={h.l} className="rounded-xl p-3 text-center border" style={{ background: PRIMARY_LIGHT, borderColor: "rgba(255,242,0,0.15)" }}>
                      <div className="text-base font-bold" style={{ color: "#FFF200" }}>{h.v}</div>
        ...
        <section className="relative py-20 lg:py-28 overflow-hidden" style={{ background: "#041E42" }}>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <span className="inline-flex items-center text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-4" style={{ background: "rgba(255,242,0,0.15)", color: "#FFF200" }}>Who We Help</span>
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">
                We File for <span style={{ color: "#FFF200" }}>Every Situation</span>
              </h2>
