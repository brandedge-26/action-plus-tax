...
export default function TaxResolutionPage() {
  return (
    <>
      <HeaderTest />
      <ServiceInactiveBanner slug="tax-resolution" />
      <main>
        ...
        <section className="relative overflow-hidden pt-16 pb-0" style={{ background: "#01567E" }}>
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[320px] pointer-events-none" style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(255,242,0,0.15) 0%, transparent 70%)" }} />
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start py-14 lg:py-20">
              <div className="flex flex-col gap-6">
                <nav className="flex items-center gap-1.5 text-xs text-white/50">
                  ...
                  <ChevronRight size={11} strokeWidth={2.5} />
                  <span style={{ color: "#FFF200" }}>Tax Resolution</span>
                </nav>
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full" style={{ background: "#FFF200", color: "#041E42" }}>Tax Resolution</span>
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-white tracking-tight leading-[1.1]">
                  Tax Resolution &amp;<br /><span style={{ color: "#FFF200" }}>IRS Support</span>
                </h1>
                ...
                <div className="flex items-center gap-3 p-4 rounded-xl border" style={{ background: PRIMARY_LIGHT, borderColor: "rgba(255,242,0,0.15)" }}>
                  <ShieldAlert size={18} strokeWidth={2} style={{ color: PRIMARY }} />
                  <p className="text-sm font-semibold" style={{ color: "#FFF200" }}>The sooner you act, the more options you have. Call us today.</p>
                </div>
                <div className="grid grid-cols-3 gap-3">
                  {[{ v: "Free", l: "Initial Consult" }, { v: "Full", l: "IRS Representation" }, { v: "$0", l: "Upfront Obligation" }].map((h) => (
                    <div key={h.l} className="rounded-xl p-3 text-center border" style={{ background: PRIMARY_LIGHT, borderColor: "rgba(255,242,0,0.15)" }}>
                      <div className="text-lg font-bold" style={{ color: "#01567E" }}>{h.v}</div>
                      <div className="text-[10px] text-gray-500 mt-0.5 leading-tight">{h.l}</div>
                    </div>
                  ))}
                </div>
                <div className="flex flex-col sm:flex-row gap-3">
                  <Link href="/consultation" className="inline-flex items-center justify-center gap-2 text-white font-bold px-7 py-3.5 rounded-xl text-base hover:opacity-90 transition-all" style={{ background: "#FFF200", color: "#041E42" }}>
                    Get Free Consultation <ArrowRight size={17} strokeWidth={2.5} />
                  </Link>
                  <a href="tel:9125592222" className="inline-flex items-center justify-center gap-2 border border-white/30 hover:border-[#FFF200] text-white hover:text-[#FFF200] font-semibold px-7 py-3.5 rounded-xl text-base transition-all">
              ...
              <div className="relative">
                ...
                <div className="relative rounded-3xl p-8 border" style={{ background: "#041E42", borderColor: "rgba(255,255,255,0.07)" }}>
                  <div className="absolute inset-0 rounded-3xl pointer-events-none opacity-[0.12]" aria-hidden="true" style={{ backgroundImage: `linear-gradient(rgba(255,242,0,0.25) 1px, transparent 1px), linear-gradient(90deg, rgba(255,242,0,0.25) 1px, transparent 1px)`, backgroundSize: "32px 32px" }} />
                  <div className="relative">
                    ...
                    <ul className="space-y-3.5">
                      {includes.map((item) => (
                        <li key={item} className="flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5" style={{ background: "rgba(255,255,255,0.12)" }}>
        ...
        <section className="py-20 lg:py-28" style={{ background: "#F0F8FA" }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0A0A] tracking-tight">How We <span style={{ color: "#01567E" }}>Resolve Your IRS Issue</span></h2>
        ...
        <section className="relative py-20 lg:py-28 overflow-hidden" style={{ background: "#041E42" }}>
          <div className="absolute inset-0 pointer-events-none" aria-hidden="true" style={{ backgroundImage: `linear-gradient(rgba(255,255,255,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.05) 1px, transparent 1px)`, backgroundSize: "48px 48px" }} />
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[300px] pointer-events-none" style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(255,242,0,0.15) 0%, transparent 70%)" }} />
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <span className="inline-flex items-center text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-4" style={{ background: "rgba(255,242,0,0.15)", color: "#FFF200" }}>Resolution Options</span>
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">Every IRS Problem Has <span style={{ color: "#FFF200" }}>a Solution</span></h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {resolutionServices.map((item) => {
                ...
                return (
                  <div key={item.title} className="group rounded-2xl p-6 border transition-all hover:border-[#FFF200] flex flex-col gap-4" style={{ background: "rgba(255,255,255,0.03)", borderColor: "rgba(255,255,255,0.07)" }}>
        ...
        <section className="py-16 lg:py-20" style={{ background: "#F0F8FA" }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link href="/services" className="flex items-center gap-1 text-xs font-bold" style={{ color: "#FFF200" }}>View All <ChevronRight size={13} strokeWidth={2.5} /></Link>
            </div>
        ...
        <section className="py-20 lg:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative rounded-3xl overflow-hidden px-10 sm:px-16 py-16 text-center" style={{ background: "#041E42" }}>
              <div className="absolute inset-0 pointer-events-none opacity-20" style={{ backgroundImage: `linear-gradient(rgba(255,242,0,0.25) 1px, transparent 1px), linear-gradient(90deg, rgba(255,242,0,0.25) 1px, transparent 1px)`, backgroundSize: "40px 40px" }} />
