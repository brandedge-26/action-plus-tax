                ...
                <div className="grid grid-cols-3 gap-3">
                  {[{ v: "Free", l: "Initial Consult" }, { v: "Full", l: "IRS Representation" }, { v: "$0", l: "Upfront Obligation" }].map((h) => (
                    <div key={h.l} className="rounded-xl p-3 text-center border" style={{ background: PRIMARY_LIGHT, borderColor: "rgba(255,242,0,0.15)" }}>
                      <div className="text-lg font-bold" style={{ color: "#FFF200" }}>{h.v}</div>
                    ...
                    <ul className="space-y-3.5">
                      {includes.map((item) => (
                        <li key={item} className="flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5" style={{ background: "rgba(255,242,0,0.15)" }}>
        ...
        <section className="py-20 lg:py-28" style={{ background: "#F0F8FA" }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0A0A] tracking-tight">How We <span style={{ color: "#FFF200" }}>Resolve Your IRS Issue</span></h2>
