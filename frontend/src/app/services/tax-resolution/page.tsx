    ...
    <>
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start py-14 lg:py-20">
              <div className="flex flex-col gap-6">
                <nav className="flex items-center gap-1.5 text-xs text-white/50">
                  ...
                  <ChevronRight size={11} strokeWidth={2.5} />
                  <span style={{ color: "#FFC200" }}>Tax Resolution</span>
                </nav>
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full" style={{ background: "#FFC200", color: "#001A57" }}>Tax Resolution</span>
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-white tracking-tight leading-[1.1]">
                  Tax Resolution &amp;<br /><span style={{ color: "#FFC200" }}>IRS Support</span>
                </h1>
                ...
                <div className="flex items-center gap-3 p-4 rounded-xl border" style={{ background: PRIMARY_LIGHT, borderColor: "rgba(255,194,0,0.15)" }}>
                  <ShieldAlert size={18} strokeWidth={2} style={{ color: PRIMARY }} />
                  <p className="text-sm font-semibold" style={{ color: "#FFC200" }}>The sooner you act, the more options you have. Call us today.</p>
                </div>
                <div className="grid grid-cols-3 gap-3">
                  {[{ v: "Free", l: "Initial Consult" }, { v: "Full", l: "IRS Representation" }, { v: "$0", l: "Upfront Obligation" }].map((h) => (
                    <div key={h.l} className="rounded-xl p-3 text-center border" style={{ background: PRIMARY_LIGHT, borderColor: "rgba(255,194,0,0.15)" }}>
                      <div className="text-lg font-bold" style={{ color: "#FFC200" }}>{h.v}</div>
        ...
        <section className="py-20 lg:py-28" style={{ background: "#F4F7FF" }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0A0A] tracking-tight">How We <span style={{ color: "#FFC200" }}>Resolve Your IRS Issue</span></h2>
        ...
        <section className="relative py-20 lg:py-28 overflow-hidden" style={{ background: "#001A57" }}>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <span className="inline-flex items-center text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-4" style={{ background: "rgba(255,194,0,0.15)", color: "#FFC200" }}>Resolution Options</span>
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">Every IRS Problem Has <span style={{ color: "#FFC200" }}>a Solution</span></h2>
