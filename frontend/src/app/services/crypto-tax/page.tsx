...
import {
  ...
  BarChart2, Layers, Zap, Globe, DollarSign, Shield,
  ChevronRight,
} from "lucide-react";
...
const highlights = [
  { value: "Form 8949", label: "All Disposals Filed" },
  { value: "All Types", label: "Crypto, NFTs, DeFi" },
  { value: "IRS Compliant", label: "Fully Accurate" },
];
...
const steps = [
  { step: "01", title: "Export Transaction History", desc: "Download your full transaction history from all exchanges (Coinbase, Kraken, Binance, etc.) and wallets. We'll tell you exactly what format we need." },
  { step: "02", title: "Tax Pro Reviews Activity", desc: "Your Tax Pro categorizes every transaction — trades, staking rewards, NFTs, DeFi activity — and determines the correct tax treatment for each type." },
  { step: "03", title: "Calculate Gains & Losses", desc: "We compute your short-term and long-term gains, apply loss harvesting where applicable, and determine your net taxable position across all platforms." },
  { step: "04", title: "File & Stay Compliant", desc: "Form 8949 and Schedule D are completed and attached to your return. We e-file everything together with your federal and state returns." },
];

const features = [
  { icon: TrendingUp, title: "Crypto Trading", desc: "Every buy, sell, and exchange is accounted for. We calculate your cost basis, holding periods, and net gain or loss across all centralized and decentralized exchanges." },
  { icon: Layers, title: "NFT Transactions", desc: "NFT sales, minting costs, and royalties are all taxable events. We correctly categorize NFT activity as capital gains or ordinary income depending on your situation." },
  { icon: Zap, title: "Staking & Staking Rewards", desc: "Staking rewards are taxed as ordinary income when received. We report the fair market value at receipt and track the new cost basis for future disposals." },
  { icon: Globe, title: "DeFi & Yield Farming", desc: "Liquidity pool income, yield farming rewards, and DeFi lending interest are complex areas. We stay current on IRS guidance and apply the correct treatment to each activity type." },
  { icon: BarChart2, title: "Mining Income", desc: "Crypto received through mining is ordinary income at fair market value. We report it correctly and track cost basis for when you eventually sell or exchange those coins." },
  { icon: DollarSign, title: "Crypto as Payment", desc: "Receiving crypto as payment for services is ordinary income. Spending or exchanging it later triggers a capital gain or loss. We track both events across your entire history." },
];

const faqs = [
  { q: "Is cryptocurrency taxable?", a: "Yes. The IRS treats cryptocurrency as property. Every time you sell, trade, exchange, or spend crypto, it's a taxable event. You must report gains and losses on Form 8949 and Schedule D. Receiving crypto as income — staking, mining, or payment — is taxed as ordinary income." },
  { q: "What forms do I need to report crypto?", a: "Most crypto taxpayers need Form 8949 (to list individual transactions), Schedule D (to summarize capital gains and losses), and Schedule 1 or Schedule C if you received crypto as income. We prepare all required forms and attach them to your return." },
  { q: "What if I lost money on crypto?", a: "Crypto losses are deductible. You can use capital losses to offset capital gains, and up to $3,000 of net losses can offset ordinary income per year. Unused losses carry forward to future years. We apply your losses strategically to minimize your overall tax bill." },
  { q: "Do I have to report every single trade?", a: "Yes — the IRS requires every disposal to be reported on Form 8949, including crypto-to-crypto trades. Each trade has its own line with date acquired, date sold, proceeds, cost basis, and gain/loss. We compile all transactions from your exchange history so nothing is missed." },
];
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start py-14 lg:py-20">
              ...
              <div className="flex flex-col gap-6">
                <nav className="flex items-center gap-1.5 text-xs text-white/50">
                  ...
                  <ChevronRight size={11} strokeWidth={2.5} />
                  <span style={{ color: "#FFC200" }}>Crypto &amp; Investment Tax</span>
                </nav>
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-white tracking-tight leading-[1.1]">
                  ...
                  <span style={{ color: "#FFC200" }}>Tax Reporting</span>
                </h1>

                <p className="text-white/70 text-lg leading-relaxed">
                  Accurate, IRS-compliant reporting for all cryptocurrency activity — trading, staking,
                  mining, NFTs, and DeFi. We handle Form 8949, Schedule D, and every taxable event
                  across all your wallets and exchanges.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-1">
                  <Link href="/consultation"
                    ...
                    style={{ background: "#FFC200", color: "#001A57" }}
                  >
                    Report My Crypto Taxes <ArrowRight size={17} strokeWidth={2.5} />
                  </Link>
              ...
              <div className="relative">
                ...
                <div className="relative rounded-3xl p-8 border" style={{ background: "#001A57", borderColor: "rgba(255,255,255,0.07)" }}>
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-xl font-bold text-white mb-6">Complete Crypto Tax Reporting</h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0A0A] tracking-tight">
                From Transaction History to <span style={{ color: "#FFC200" }}>Filed Return</span>
              </h2>
              <p className="mt-4 text-gray-500 text-lg max-w-xl mx-auto">We turn your exchange exports into a fully compliant crypto tax return.</p>
            </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">
                Every Type of <span style={{ color: "#FFC200" }}>Crypto Activity</span>
              </h2>
        ...
        <section className="py-20 lg:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative rounded-3xl overflow-hidden px-10 sm:px-16 py-16 text-center" style={{ background: "#001A57" }}>
              ...
              />
              <div className="relative">
                <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: "#FFC200" }}>Get Started Today</p>
                <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
                  File Your Crypto Taxes Accurately — and Confidently
                </h2>
                <p className="text-gray-400 text-base max-w-xl mx-auto mb-8">
                  Don&apos;t let complex crypto activity go unreported. Our Tax Pros handle every transaction type
                  and keep you fully compliant with IRS requirements.
                </p>
