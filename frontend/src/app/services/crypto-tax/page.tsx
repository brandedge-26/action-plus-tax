            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start py-14 lg:py-20">
              ...
              <div className="flex flex-col gap-6">
                <nav className="flex items-center gap-1.5 text-xs text-gray-400">
                  ...
                  <ChevronRight size={11} strokeWidth={2.5} />
                  <span style={{ color: PRIMARY }}>Crypto &amp; Investment Tax</span>
                </nav>
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-[#0A0A0A] tracking-tight leading-[1.1]">
                  ...
                  <span style={{ color: PRIMARY }}>Tax Reporting</span>
                </h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0A0A] tracking-tight">
                From Transaction History to <span style={{ color: PRIMARY }}>Filed Return</span>
              </h2>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">
                Every Type of <span style={{ color: PRIMARY }}>Crypto Activity</span>
              </h2>
